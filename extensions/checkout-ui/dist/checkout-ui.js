...
${errorInfo.componentStack}`);
  ...
  function Extension() {
    const res = useApi();
    const [showBanner, setShowBanner] = (0, import_react14.useState)(false);
    console.log(res);
    return /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(BlockStack2, { children: [
      showBanner && /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Banner2, { status: "success", title: "Successfully copied the UPI number to clip board.", onDismiss: () => setShowBanner(false) }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Heading2, { level: 1, children: "Payment" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "If you have not paid yet, you can you can pay us through UPI to the following phone number." }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "bold", size: "medium", children: "9113686752" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsxs)(Text2, { children: [
        "The name in the UPI app should appear as ",
        /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { emphasis: "italic", children: " Vinayaka K V/ Nagarathna K S" })
      ] }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Text2, { children: "Otherwise, you can also directly scan the below QR code" }),
      /* @__PURE__ */ (0, import_jsx_runtime4.jsx)(Image2, { source: "https://cdn.shopify.com/s/files/1/0797/3774/9792/files/2024-06-12_20.12.28.jpg?v=1718203438" })
    ] });
  }
})();
